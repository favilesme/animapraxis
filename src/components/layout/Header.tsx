...
const navLinks = [
  { to: "/", label: "Inicio" },
  { to: "/consultoria-ia", label: "Consultoría Estratégica" },
  { to: "/coaching-terapia", label: "Coaching Ontológico" },
  { to: "/capacitacion-corporativa", label: "Liderazgo Organizacional" },
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-[#040c2a] text-deep-foreground border-b border-[#040c2a] shadow-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between gap-4 bg-[#040c2a]">
